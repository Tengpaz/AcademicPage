...
<template>
  <section id="contact" class="card reveal" style="--delay: 0.55s">
    <h2>{{ props.title }}</h2>
    ...
    <ul class="contact-list">
      ...
      <li><span>{{ props.phoneLabel }}</span> <span>{{ props.profile.contact.phone }}</span></li>
      <li><span>{{ props.wechatLabel }}</span> <span>{{ props.profile.contact.wechat }}</span></li>
      <li><span>{{ props.locationLabel }}</span> <span>{{ props.profile.contact.location }}</span></li>
    </ul>
  </section>
</template>
